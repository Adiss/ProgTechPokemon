...
public enum Effectiveness {
    ...
    static {
        ...
        // FIGHTINGING
        typeEffectiveness.put("FIGHTINGINGNORMAL", 2.0);typeEffectiveness.put("FIGHTINGINGFIRE", 1.0);typeEffectiveness.put("FIGHTINGINGWATER", 1.0);typeEffectiveness.put("FIGHTINGINGELECTRIC", 1.0);
        typeEffectiveness.put("FIGHTINGINGGRASS", 1.0);typeEffectiveness.put("FIGHTINGINGICE", 2.0);typeEffectiveness.put("FIGHTINGINGFIGHTINGING", 1.0);typeEffectiveness.put("FIGHTINGINGPOISON", 0.5);
        typeEffectiveness.put("FIGHTINGINGGROUND", 1.0);typeEffectiveness.put("FIGHTINGINGFLYING", 0.5);typeEffectiveness.put("FIGHTINGINGPSYCHIC", 0.5);typeEffectiveness.put("FIGHTINGINGBUG", 0.5);
        typeEffectiveness.put("FIGHTINGINGROCK", 2.0);typeEffectiveness.put("FIGHTINGINGGHOST", 0.0);typeEffectiveness.put("FIGHTINGINGDRAGON", 1.0);typeEffectiveness.put("FIGHTINGINGDARK", 2.0);
        typeEffectiveness.put("FIGHTINGINGSTEEL", 2.0);typeEffectiveness.put("FIGHTINGINGFAIRY", 0.5);
        // POISON
        ...
        typeEffectiveness.put("POISONGRASS", 2.0);typeEffectiveness.put("POISONICE", 1.0);typeEffectiveness.put("POISONFIGHTINGING", 1.0);typeEffectiveness.put("POISONPOISON", 0.5);
        ...
        typeEffectiveness.put("GROUNDGRASS", 0.5);typeEffectiveness.put("GROUNDICE", 1.0);typeEffectiveness.put("GROUNDFIGHTINGING", 1.0);typeEffectiveness.put("GROUNDPOISON", 2.0);
        ...
        typeEffectiveness.put("FLYINGGRASS", 2.0);typeEffectiveness.put("FLYINGICE", 1.0);typeEffectiveness.put("FLYINGFIGHTINGING", 2.0);typeEffectiveness.put("FLYINGPOISON", 2.0);
        ...
        typeEffectiveness.put("PSYCHICGRASS", 1.0);typeEffectiveness.put("PSYCHICICE", 1.0);typeEffectiveness.put("PSYCHICFIGHTINGING", 2.0);typeEffectiveness.put("PSYCHICPOISON", 2.0);
        ...
        typeEffectiveness.put("BUGGRASS", 2.0);typeEffectiveness.put("BUGICE", 1.0);typeEffectiveness.put("BUGFIGHTINGING", 0.5);typeEffectiveness.put("BUGPOISON", 0.5);
        ...
        typeEffectiveness.put("GHOSTGRASS", 1.0);typeEffectiveness.put("GHOSTICE", 1.0);typeEffectiveness.put("GHOSTFIGHTINGING", 1.0);typeEffectiveness.put("GHOSTPOISON", 1.0);
        ...
        typeEffectiveness.put("DRAGONGRASS", 1.0);typeEffectiveness.put("DRAGONICE", 1.0);typeEffectiveness.put("DRAGONFIGHTINGING", 1.0);typeEffectiveness.put("DRAGONPOISON", 1.0);
        ...
        typeEffectiveness.put("DARKGRASS", 1.0);typeEffectiveness.put("DARKICE", 1.0);typeEffectiveness.put("DARKFIGHTINGING", 0.5);typeEffectiveness.put("DARKPOISON", 1.0);
        ...
        typeEffectiveness.put("STEELGRASS", 1.0);typeEffectiveness.put("STEELICE", 2.0);typeEffectiveness.put("STEELFIGHTINGING", 1.0);typeEffectiveness.put("STEELPOISON", 1.0);
        ...
        typeEffectiveness.put("FAIRYGRASS", 1.0);typeEffectiveness.put("FAIRYICE", 1.0);typeEffectiveness.put("FAIRYFIGHTINGING", 2.0);typeEffectiveness.put("FAIRYPOISON", 0.5);
